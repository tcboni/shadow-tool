...
- **Many presets** — including _Near / Mid / Far_, three graduated elevations in the style of Josh Comeau's shadow palettes, plus hard-edged _Pop_ and _Slice_, 16-step _Long_, _Neon_/_Aura_/_Ring_ glows on dark stages, neumorphic _Puff_, and inset _Well_. Every preset dresses the whole stage — background, fill, radius, and light position.
